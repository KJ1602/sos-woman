...
//pt2 aquiiiiiiiiiiiiiiiii
        {
            ...
            choices: [
                { text: 'Continuar insistindo em ligar para Lucas', nextScene: 19 },
                { text: 'Arrumar as coisas e ir ao hospital, deixando um bilhete', nextScene: 32 }
            ]
        },
        {
            image: 'phone.jpg',
            ...
            choices: [
                { text: 'Voltar para casa e esperar', nextScene: 20 }
            ]
        },
        {
            image: 'hospital.jpg',
            ...
            choices: [
                { text: 'Negar e apaziguar a médica', nextScene: 33},
